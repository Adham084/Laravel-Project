            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <h1 class="banner_taital">Tablates And Phons Repair Service</h1>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="blog_taital_main">
                                ...
                                <p class="ipsum_text">There are many variations of passages of Lorem Ipsum available, but
                                    the majority
                        ...
                        <div class="map_main">
                            <div class="map-responsive">
                                <iframe
                                    ...
                                    width="600" height="550" frameborder="0" style="border:0; width: 100%;"
